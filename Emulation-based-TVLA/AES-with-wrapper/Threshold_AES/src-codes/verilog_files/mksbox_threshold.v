...
//
// On Sun Apr 17 15:04:37 IST 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mksbox_threshold(seed_1,
			seed_2,
			seed_3,
			CLK,
			RST_N,
  ...
  // ports of submodule sb
  wire [23 : 0] sb$r2, sb$r3;
  wire [15 : 0] sb$r1;
  wire [7 : 0] sb$in, sb$out;
  ...
  // actionvalue method getbyte
  assign getbyte = sb$out ;
  assign RDY_getbyte = 1'd1 ;

  // submodule sb
  sbox sb(.in(sb$in), .r1(sb$r1), .r2(sb$r2), .r3(sb$r3), .out(sb$out));
  ...
  // submodule sb
  assign sb$in = getbyte_in ;
  assign sb$r1 = lfsr_1_r ;
  assign sb$r2 = lfsr_2_r ;
  assign sb$r3 = lfsr_3_r ;
