...
//
// On Fri May  6 14:48:27 IST 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkAES_Wrapper2(CLK,
  ...
  wire [31 : 0] counter_3_PLUS_1___d24;
  ...
  // register counter
  assign counter$D_IN =
	     WILL_FIRE_RL_process2_complete ? counter_3_PLUS_1___d24 : 32'd0 ;
  ...
  // remaining internal signals
  assign counter_3_PLUS_1___d24 = counter + 32'd1 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_process1_complete)
	$display(v__h1074, " Output of decryption: %h", aes_$ret);
  end
  // synopsys translate_on
