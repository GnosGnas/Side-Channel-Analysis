...
int main()
{
  ...
  *aes_config=0;                  //Encrypt=0 / Decrypt=1

  *dma_cndtr2= 48;                //Size of input in bytes
  *dma_cmar2= inp;               //Memory address
  printf("%lx\n",*dma_cmar2);
  *dma_cpar2= 0x00021000;         //Peripheral address
  

  //Setup reading output from AES
  *dma_cndtr1= 48;                //Size of input in bytes
  *dma_cmar1= outp_ptr;           //Memory address
  *dma_cpar1= 0x00021040;         //Peripheral address
