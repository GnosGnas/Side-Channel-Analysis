...
//
// On Fri Jan 28 14:57:22 IST 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkAES_Wrapper2(CLK,
  ...
  assign MUX_mod_state$write_1__SEL_1 =
	     mod_state == 3'd1 && !delayer_SLT_3___d7 ;
  ...
  assign MUX_delayer$write_1__VAL_1 =
	     delayer_SLT_3___d7 ? delayer + 32'd1 : 32'd0 ;
  ...
  // submodule aes_
  assign aes_$encrypt_decrypttt = 1'd0 ;
  ...
  assign delayer_SLT_3___d7 = (delayer ^ 32'h80000000) < 32'h80000003 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_process1_complete)
	$display(v__h1092, " Output of encryption: %h", aes_$ret);
  end
  // synopsys translate_on
